...
// Include SweetAlert Library (place this in your HTML <head> or at the top of the file)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_GET['edit_id'])) {
    if (isset($_POST['customerId'], $_POST['appointmentDate'], $_POST['appointmentTime'], $_POST['ServiceType'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $fullName = null; // Handle case when no active customer is found
        }
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<script>
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
                    text: 'Appointment booked successfully. Your Appointment ID is: $appointmentId'
                }).then(() => {
...
$sql = "SELECT a.appointmentId, co.fullName, co.carModel, co.contactNumber AS contactNumber, 
                        ...
                        <form class="form-sample" method="POST">
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control form-control-lg" id="service-type-select" name="ServiceType" aria-label="Service Type" required>
